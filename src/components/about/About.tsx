...
import './About.css'; // Make sure to add Why Us CSS here or in About.css
import fototurist from '../../assets/fototurist2.webp';
    ...
    <section className="about-section">
      <h1 className="about-title">
        ...
        <div className="about-title-image-container">
          ...
          <span className="about-image-overlay-text">
            <h2 className="lato-bold-italic">
      ...
      <div className="about-grid">
        ...
        <img
          src={fototurist} alt="Mission"
        />
       </div>
      {/* ======= Add Why Us Section Here ======= */}
      <section className="why-us-section">
        <div className="why-us-container">
          <h2 className="why-us-title">Why Us</h2>
          <p className="why-us-text">
            We provide exceptional service with expert knowledge, ensuring your satisfaction with every project. Our team is dedicated, professional, and friendly — making us your trusted partner.
          </p>
        </div>
      </section>
